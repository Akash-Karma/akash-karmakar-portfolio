            ...
            >
              ...
              <div className="flex-1" style={{ perspective: '1000px' }}>
                ...
                >
                  ...
                  >
                    <div>
                      <h3 className="text-sm font-heading font-bold text-foreground mb-2 line-clamp-2">
                        {cert.title}
                      </h3>
                      ...
                      <div className="flex flex-wrap gap-1 mb-3">
                        {cert.skills.map((skill, i) => (
                          <span
                            key={i}
                            className="px-2 py-0.5 bg-gradient-primary text-white text-xs rounded-full font-medium"
                          >
                            {skill}
                          </span>
                        ))}
