    ...
    <section id="services" className="section-padding bg-white/50">
      <div className="max-w-7xl mx-auto">
            ...
            >
              {window5.map((service, pos) => (
                <div
                  ...
                  className={`card-project ${service.borderColor} hover:scale-[1.02] transition-transform duration-300`}
                >
                  <CardContent service={service} />
                </div>
              ))}
        ...
        <div className="card-gradient">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              { step: "02", title: "Planning", description: "Creating detailed roadmap and technical architecture" },
              { step: "03", title: "Development", description: "Building solution with regular updates and feedback" },
              { step: "04", title: "Maintenance", description: "Ensuring stability with monitoring, updates, and ongoing improvements" }
            ].map((phase, index) => (
        ...
        {/* <div className="text-center mt-16">
          ...
          <Button onClick={handleContactClick} className="btn-hero">
            Connect With Me
