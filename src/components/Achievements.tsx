...
const Achievements = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description: "Solved over 500 coding problems across multiple competitive programming platforms including LeetCode, Codeforces, CodeChef, AtCoder, and GeeksForGeeks.",
